  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const onPointerDown = (e: PointerEvent) => {
        ...
        const clickPositions = uniforms.uClickPos.value as THREE.Vector2[];
        clickPositions[ix].set(fx, fy);
        const clickTimes = uniforms.uClickTimes.value as Float32Array;
        clickTimes[ix] = uniforms.uTime.value;
