    ...
    <RippleBackground>
      <section className="w-full h-screen overflow-hidden md:overflow-visible flex flex-col items-center justify-center relative">
        <Floating sensitivity={-0.5} className="h-full pointer-events-none">
          <FloatingElement
            depth={0.5}
            className="top-[15%] left-[2%] md:top-[25%] md:left-[5%] pointer-events-auto"
          >
            <motion.img
          ...
          <FloatingElement
            depth={1}
            className="top-[0%] left-[8%] md:top-[6%] md:left-[11%] pointer-events-auto"
          >
            <motion.img
          ...
          <FloatingElement
            depth={4}
            className="top-[90%] left-[6%] md:top-[80%] md:left-[8%] pointer-events-auto"
          >
            <motion.img
          ...
          <FloatingElement
            depth={2}
            className="top-[0%] left-[87%] md:top-[2%] md:left-[83%] pointer-events-auto"
          >
            <motion.img
          ...
          <FloatingElement
            depth={1}
            className="top-[78%] left-[83%] md:top-[68%] md:left-[83%] pointer-events-auto"
          >
            <motion.img
        ...
        <div className="flex flex-col justify-center items-center w-[250px] sm:w-[300px] md:w-[500px] lg:w-[700px] z-50 pointer-events-auto select-none">
          <motion.h1
            className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl text-center w-full justify-center items-center flex-col flex whitespace-pre leading-tight font-calendas tracking-tight space-y-1 md:space-y-4 text-gray-900"
          ...
          <motion.p
            className="text-sm sm:text-lg md:text-xl lg:text-2xl text-center font-overusedGrotesk pt-4 sm:pt-8 md:pt-10 lg:pt-12 text-gray-600"
            animate={{ opacity: 1, y: 0 }}
            initial={{ opacity: 0, y: 20 }}
          ...
          <div className="flex flex-row justify-center space-x-4 items-center mt-10 sm:mt-16 md:mt-20 lg:mt-20 text-xs">
            <motion.button
              className="sm:text-base md:text-lg lg:text-xl font-semibold tracking-tight text-white bg-gray-900 px-4 py-2 sm:px-5 sm:py-2.5 md:px-6 md:py-3 lg:px-8 lg:py-3 rounded-full z-20 shadow-2xl font-calendas"
              animate={{ opacity: 1, y: 0 }}
              initial={{ opacity: 0, y: 20 }}
              transition={{
                duration: 0.2,
